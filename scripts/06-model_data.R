...
saveRDS(
  bayesian_model_1,
  file = "models/bayesian_model_1_harris.rds"
)
...
write.csv(train_data, "./data/02-analysis_data/train_data_harris.csv")
write.csv(test_data, "./data/02-analysis_data/test_data_harris.csv")
...
write.csv(train_data, "./data/02-analysis_data/train_data_trump.csv")
write.csv(test_data, "./data/02-analysis_data/test_data_trump.csv")
