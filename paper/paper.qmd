...
This paper fills the gap by building a hybrid election forecasting model following the strategies mentioned by @pasek. We incorporate aggregation by filtering the polls by numeric grade that indicates pollster’s reliability, prediction that incorporates historical data and economic indicators, and hybrid approaches that leverages Bayesian techniques, allowing for a dynamic prediction of the U.S. presidential election. 
